...
export default function HeroSection({
  ...
  useEffect(() => {
    ...
    heroTl.fromTo(
      ...
      { visibility: 'visible', y: '0%', duration: 0.9, ease: 'power3.out' },
      '-=0.8'
    )

    // 5. Name text bottom - slide up from below (overflow-hidden mask)
    heroTl.fromTo(
          ...
          <div className="home_hero_wrapper">
            <div className="home_hero_grid is-top">
              <div className="overflow-hidden">
                <h1 className="home_hero_name-text-top">
                  {logoTopUrl ? (
                    <img src={logoTopUrl} alt={titleTop} className="home_hero_logo-svg" draggable={false} />
                  ) : (
            ...
            <div className="home_hero_grid is-bitton">
              <div className="home_hero_role-based">
                <div className="overflow-hidden">
                  <div className="home_hero-role">
                    <p className="text-size-regular">{role}</p>
                  </div>
                </div>
                <div className="overflow-hidden">
              ...
              <div className="overflow-hidden">
                <div className="home_hero_name-text-bottom">
                  {logoBottomUrl ? (
                    <img src={logoBottomUrl} alt={titleBottom} className="home_hero_logo-svg" draggable={false} />
                  ) : (
