...
export default function Navbar() {
  ...
  return (
    <header ref={navRef}>
      <nav className="nav-home_component" aria-label="Navigation principale">
        <div className="padding-global">
          <div className="nav-home_wrapper">
            <div className="overflow-hidden hide-tablet">
              <Link href="/" className="nav-home_name-desktop hide-tablet inline-block">
                <svg viewBox="0 0 1273 65" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="Kylian Roger" className="nav-home_name-svg text-color-alternate">
            ...
            <div className="overflow-hidden hide-just-desktop">
              <Link href="/" className="nav-home_name-tablet-mobile inline-block">
                <svg viewBox="0 0 1273 65" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="Kylian Roger" className="nav-home_name-svg text-color-alternate">
                  <path d="M111.32 3.97L56.52 30.65V31.1L114.04 60.04V62.75H69.82L26.59 41.05H25.14V62.75H0V1.26H25.14V22.42H26.59L70 1.26H111.33V3.97H111.32Z"/>
                  <path d="M173.24 20.52L194.67 1.26H230.12V2.16L185.71 41.95V62.75H160.57V41.95L116.17 2.16V1.26H151.62L173.05 20.52H173.24Z"/>
                  <path d="M261.76 42.32H327.51V62.76H236.62V1.26H261.76V42.32Z"/>
            ...
            <div className="nav-home_menu" ref={menuRef}>
              {/* Main menu */}
              <div className="nav-menu-main">
                <div className="overflow-hidden">
                  ...
                  >
                    <span className="text-color-alternate">HOME</span>
                  </Link>
                </div>
                <div className="overflow-hidden">
                  <button
                  ...
                  >
                    <span className="text-color-alternate">WORKS</span>
                  </button>
                </div>
                <div className="overflow-hidden">
                  <Link
                  ...
                  >
                    <span className="text-color-alternate">CONTACT</span>
                  </Link>
                </div>
              </div>
              {/* Works submenu */}
              <div className="nav-menu-sub" aria-hidden="true">
                ...
                <div className="overflow-hidden">
                  ...
                  >
                    <span className="text-color-alternate">PHOTOGRAPHY</span>
                  </Link>
                </div>
                <div className="overflow-hidden">
                  <Link
                    href="/film-motion"
                    className="nav-home_menu-item inline-block"
                    aria-current={isActive('/film-motion') ? 'page' : undefined}
                  >
                    <span className="text-color-alternate">FILM/MOTION</span>
                  </Link>
                </div>
                <div className="overflow-hidden">
                  <Link
                    href="/art-direction"
                    className="nav-home_menu-item inline-block"
                    aria-current={isActive('/art-direction') ? 'page' : undefined}
                  >
                    <span className="text-color-alternate">ART DIRECTION</span>
                  </Link>
                </div>
              </div>
              {/* Theme toggle */}
