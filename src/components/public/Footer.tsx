...
export default function Footer({ bigName, copyright }: FooterProps) {
    ...
    <footer className="footer_component">
          ...
          <nav className="nav-home_menu footer" ref={menuRef} aria-label="Navigation pied de page">
            ...
            <div className="nav-menu-main footer">
              <div className="overflow-hidden">
                <Link href="/" className="nav-home_menu-item inline-block">
                  <span className="text-color-alternate footer">HOME</span>
                </Link>
              </div>
              <div className="overflow-hidden">
                <button
                ...
                >
                  <span className="text-color-alternate footer">WORKS</span>
                </button>
              </div>
              <div className="overflow-hidden">
                <Link href="/contact" className="nav-home_menu-item inline-block">
                  <span className="text-color-alternate footer">CONTACT</span>
                </Link>
              </div>
            </div>
            {/* Works submenu */}
            <div className="nav-menu-sub footer" aria-hidden="true">
              ...
              <div className="overflow-hidden">
                <Link href="/photography" className="nav-home_menu-item inline-block">
                  <span className="text-color-alternate footer">PHOTOGRAPHY</span>
                </Link>
              </div>
              <div className="overflow-hidden">
                <Link href="/film-motion" className="nav-home_menu-item inline-block">
                  <span className="text-color-alternate footer">FILM/MOTION</span>
                </Link>
              </div>
              <div className="overflow-hidden">
                <Link href="/art-direction" className="nav-home_menu-item inline-block">
                  <span className="text-color-alternate footer">ART DIRECTION</span>
                </Link>
              </div>
            </div>
          </nav>
      ...
      <div className="footer_big-name-text-wrapper">
        <div className="footer_big-name-text" ref={bigNameRef}>
          <svg viewBox="0 0 1273 65" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label={bigName}>
